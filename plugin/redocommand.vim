...
"   1.40.009	20-Jul-2012	ENH: Add :RedoBufferRepeat and
...
if ! exists('g:redocommand_no_short_command') || ! g:redocommand_no_short_command
    ...
    command! -count=0 -nargs=* -complete=command RB call redocommand#RedoBufferRepeat(<count>, <f-args>)
    command! -count=0 -nargs=* -complete=command RW call redocommand#RedoWindowRepeat(<count>, <f-args>)
endif
...
command! -count=0 -nargs=* -complete=command RedoBufferRepeat  call redocommand#RedoBufferRepeat(<count>, <f-args>)
command! -count=0 -nargs=* -complete=command RedoWindowRepeat  call redocommand#RedoWindowRepeat(<count>, <f-args>)
